// Next run Pass --tritonamdgpu-optimize-dot-operands
// IR Dump After TritonAMDGPUOptimizeEpilogue ('builtin.module' operation)
// Current Run Pass --tritonamdgpu-optimize-epilogue
