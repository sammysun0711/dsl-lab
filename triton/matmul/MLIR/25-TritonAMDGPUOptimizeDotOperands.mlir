// Next run Pass --tritonamdgpu-hoist-layout-conversions
// IR Dump After TritonAMDGPUOptimizeDotOperands ('builtin.module' operation)
// Current Run Pass --tritonamdgpu-optimize-dot-operands
