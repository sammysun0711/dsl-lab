// Next run Pass --tritonamdgpu-sink-layout-conversions
// IR Dump After TritonAMDGPUHoistLayoutConversions ('tt.func' operation: @matmul_kernel)
// Current Run Pass --tritonamdgpu-hoist-layout-conversions
