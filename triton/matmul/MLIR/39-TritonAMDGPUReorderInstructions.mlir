// Next run Pass --tritonamdgpu-block-pingpong
// IR Dump After TritonAMDGPUReorderInstructions ('builtin.module' operation)
// Current Run Pass --tritonamdgpu-reorder-instructions
