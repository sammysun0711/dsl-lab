// Next run Pass --tritonamdgpu-canonicalize-pointers
// IR Dump After TritonAMDGPUBlockPingpong ('builtin.module' operation)
// Current Run Pass --tritonamdgpu-block-pingpong
