// Next run Pass --convert-warp-pipeline
// IR Dump After TritonAMDGPUUpdateAsyncWaitCount ('builtin.module' operation)
// Current Run Pass --tritonamdgpu-update-async-wait-count
