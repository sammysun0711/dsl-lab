// Next run Pass --convert-triton-amdgpu-to-llvm
// IR Dump After AllocateAMDGPUSharedMemory ('builtin.module' operation)
// Current Run Pass --allocate-amdgpu-shared-memory
